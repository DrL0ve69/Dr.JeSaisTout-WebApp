...
|---|---|---|
| 🔴 **Cours PHP, format « En bref »** — PRIORITAIRE | ✅ **les sept modules en ligne, 7/7** ; ✅ **PHP-F** (2026-09-22 : le gate du format actionnable voit les deux cours, clef `<sujet>/<slug>`). ✅ **PHP-F2** (2026-09-22 : les sept modules PHP déclarés conformes, la liste passe à 16 clefs). ✅ **PHP-R** (2026-09-22 : 31 voies posées dans les marches des modules de sécurité 01, 02, 03, 04, 11). Geste suivant : **PHP-A2**, le seul lot ⬜ du §6, ou l'un des deux lots de dette nommés ci-dessous (`powershell`, lieu d'exécution des blocs PHP). | [`docs/agile/reprise-php-en-bref.md`](docs/agile/reprise-php-en-bref.md) — lire sa DERNIÈRE section, puis son §6 |
