---
titre: "Leçon témoin — un module rattaché à une évaluation PRATIQUE"
slug: temoin
sujet: securite-web
ordre: 1
seance: 4
...
# Leçon témoin — un module rattaché à une évaluation PRATIQUE
...
::: cours
Ce module déclare « seance: 4 », et la séance 4 de l'horaire PORTE une évaluation :
le « Projet de session », de nature « evaluation-pratique ». Le validateur l'ACCEPTE — c'est
l'arbitrage R-3 du 2026-08-31. La séance 3, elle, est un « examen-ecrit » : un module qui la
citerait serait refusé, et c'est la fixture « invalides/seance-du-module-est-une-evaluation »
qui le prouve. Sans CETTE moitié-ci, « refuse un examen » serait indistinguable de « refuse
toute évaluation », c'est-à-dire du contrat qu'on vient d'ouvrir.
:::
