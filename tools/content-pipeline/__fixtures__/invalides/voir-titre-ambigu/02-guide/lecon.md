---
titre: "Le module qui PORTE la marche à suivre"
slug: guide
sujet: securite-web
ordre: 2
...
# Le module qui PORTE la marche à suivre
...
:::: marche-a-suivre {titre="Faire passer une leçon au validateur"}

1. {voir="Ce que le validateur regarde"} Écrire le frontmatter, puis poser les sections du
   gabarit dans leur ordre.
...
Un SECOND titre au même texte que la section ci-dessus : c'est la faute injectée. Le renvoi
« {voir="Ce que le validateur regarde"} » de la marche à suivre ne désigne plus une section unique.
