...
::: correction-du-cours {data-source="OWASP Top 10 2021 — A02"}
LA FAUTE EST À LA LIGNE D’OUVERTURE CI-DESSUS : la clef est `data-source`, pas `source`. Avant
le 2026-08-20, le `\b` de tête du motif de G3 s’ouvrait JUSTE APRÈS LE TIRET — `data-source="…"`
contentait donc le validateur, et c’est le compilateur qui refusait, sur « attribut inconnu ».
Une correction du cours contredit l’enseignant devant l’apprenant ; la source doit être lue,
pas devinée.
:::
