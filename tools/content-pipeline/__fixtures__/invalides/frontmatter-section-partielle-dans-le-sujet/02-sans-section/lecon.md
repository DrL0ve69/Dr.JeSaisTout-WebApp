...
slug: sans-section
sujet: securite-web
# 🔴 LA FAUTE INJECTÉE EST CETTE LIGNE ABSENTE : pas de « section » ici, alors que la leçon
# « 01-avec-section » du même sujet en porte une. Le champ est OPTIONNEL mais TOUT-OU-RIEN par
# sujet (E2-ST6, décision D-2). Ajouter « section: … » ci-dessus ferait passer ce cas de
# « refusé » à « accepté à tort », et le spec le rapporterait.
ordre: 2
