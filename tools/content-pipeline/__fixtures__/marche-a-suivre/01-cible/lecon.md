---
titre: "Le module CIBLE d'un renvoi de marche à suivre"
slug: cible
sujet: securite-web
ordre: 1
...
# Le module CIBLE d'un renvoi de marche à suivre
...
::: complement
Ce module existe pour être CITÉ par la marche à suivre du module voisin. Son seul rôle est
de porter un « statut: publiee », donc une page réellement prerendue.
:::
