...
La séance est héritée du frontmatter ; la référence est NUMÉRIQUE, donc le libellé rendu
est « n° 1 ».
:::

::: exercice-du-cours {seance="2" ref="8" diapos="13, 17"}
La séance est déclarée, et `diapos` est autorisé sur cette variante comme sur `::: cours`.
:::
